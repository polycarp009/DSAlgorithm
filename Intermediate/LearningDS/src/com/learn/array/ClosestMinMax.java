	 ...
	 public static int solve(int[] A) {
		 ...
		 if(min == max){
	        ...
	        for(int num : A){
	            if(num == min){
	                minimumIndex = i;
	            } else if((num == max) && (minimumIndex != -1)){
	                int noOfElement = i - minimumIndex;
	                if(noOfElement < minArrLength){
	                    minArrLength = noOfElement;
	                }
	            }
	            i++;
	        }
	        ...
	        for(int num : A){
	            if(num == max){
	                minimumIndex = i;
	            } else if((num == min) && (minimumIndex != -1)){
	                int noOfElement = i - minimumIndex;
	                if(noOfElement < minArrLength){
	                    minArrLength = noOfElement;
	                }
	  	  ...
	  	  System.out.println(minArrLength + 1);
	        return (minArrLength + 1);
